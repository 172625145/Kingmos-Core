...
#define MANTD(fp)	(((((fp.l.upper) & 0xFFFFF) | HIDDEND) << 10) | \
				(fp.l.lower >> 22))
#define HIDDEND_LL	((INT64)1 << 52)
#define MANTD_LL(fp)	((fp.ll & (HIDDEND_LL-1)) | HIDDEND_LL)
#define PACKD_LL(s,e,m)	(((INT64)((s)+((e)<<20))<<32)|(m))
...
#define __fixdfdi     __imp___dtoi
#define __adddf3      __imp___addd
#define __muldf3      __imp___muld
#define __extendsfdf2 __imp___stod
#define __subdf3      __imp___subd
#define __truncdfsf2  __imp___dtos

#define __divdf3      __imp___divd
#define __addsf3      __imp___adds
#define __divsf3      __imp___divs
#define __mulsf3      __imp___muls
#define __subsf3      __imp___subs

#define __floatsidf   __imp___itod
#define __floatsisf   __imp___itos
#define __floatusisf  __imp___utos

#define __gtdf2       __imp___gtd
#define __gedf2       __imp___ged
#define __ltdf2       __imp___ltd
#define __ledf2       __imp___led
//#define __eqdf2       __imp___led
#define __negsf2      __imp___negs
#define __negdf2      __imp___negd
...
double __floatdidf (register INT64 a1)
{
...
{
	// lilin change , has a warn-2001.12.29-begin
    //(float)__floatsidf(a1);  //origin
	return (float)__floatsidf(a1);
	// lilin change , has a warn-2001.12.29-end
}

/* convert unsigned long to float */
float __floatusisf (register unsigned long a1)
{
    // lilin change , has a warn-2001.12.29-begin
...
float __floatdisf (register INT64 a1)
{
    // lilin change , has a warn-2001.12.29-begin
	//(float)__floatdidf(a1);
	return (float)__floatdidf(a1);
