...
const int iDisplayOffsetX=21;
const int iDisplayOffsetY=53;


const int iDisplayWidth=DISPLAY_WIDTH;
const int iDisplayHeight=DISPLAY_HEIGHT;
const int iDeskTopWidth=282;//322;//DISPLAY_WIDTH + 60;//380;
const int iDeskTopHeight=492;//515;//DISPLAY_HEIGHT + 80;//280;
